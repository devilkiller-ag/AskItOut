        ...
        <div className='flex flex-col px-4 py-5 rounded-[30px] w-[90%] sm:w-[400px] max-h-[800px] bg-white shadow-lg gap-2'>
            <div className="header flex items-center justify-between">
                <div className="solverDetail flex items-center justify-center gap-2">
                    <img className='solverAvatar w-12 h-12 md:w-14 md:h-14' src={AvatarArray[solver.avtarIndex]} alt={`Solver Icon`} width={1300} height={1300} />
                    <div className="details">
                        <div className="solverName text-base font-bold black">{`${answer.userAnswered}`}</div>
