...
const BottomMenu = (props) => {
  ...
  const centralIcon = (currentPage) => {
    if (currentPage === 'HomePage') {
      ...
      return (
        <NavLink to='/write'>
          <svg id='WriteAnswerIcon' className='cursor-pointer' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      return (
        <svg id='PostIcon' className='cursor-pointer' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M14 22L22 22" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    } else if (currentPage === 'ProfilePage') {
      return (
        <svg id='LogoutIcon' className='cursor-pointer' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
