        ...
        <div className='flex flex-col px-4 py-5 rounded-[30px] max-w-[300px] sm:max-w-[500px] max-h-[800px] bg-white shadow-lg gap-2'>
            <div className="header flex items-center justify-between">
                ...
                <div className="flashcounts flex items-center gap-2">
                    ...
                    <p className='flashCounts text-sm font-semibold black'>{ question.upVote }</p>
                </div>
            </div>
            ...
            <div className='options flex item-center gap-2'>
                <svg className='flashIt cursor-pointer' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className='shareIt cursor-pointer' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
