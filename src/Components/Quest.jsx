            ...
            <div className="header flex items-center justify-between">
                <div className="solverDetail flex items-center justify-center gap-2">
                    ...
                    <div className="details">
                        <div className="askerName text-base font-bold black">Ananya Singh</div>
                        <div className="questCategory text-xs text-[#A8A8A8]">
                            Web Development
                        </div>
                    </div>
                </div>
                <div className="flashcounts flex items-center gap-2">
                    ...
                    <p className='flashCounts text-sm font-semibold black'>201</p>
                </div>
            </div>

            <div className="answer text-sm black px-8">
                Why scrollbar appears when we use viewport unit?
            </div>

            <div className='options flex item-center gap-2'>
                <svg className='flashIt' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className='saveIt' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className='shareIt' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
